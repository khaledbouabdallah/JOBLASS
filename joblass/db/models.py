...
class Job:
    ...
    tech_stack: Optional[str] = None  # JSON string of tech/skills
...
class Application:
    ...
    VALID_STATUSES = {'pending', 'applied', 'rejected', 'interview', 'offer', 'declined', 'accepted'}
...
class Score:
    ...
    def __post_init__(self):
        ...
        if any([self.tech_match, self.learning_opportunity, self.company_quality, self.practical_factors]):

...
def test_search_criteria_creation(temp_db):
...
def test_search_session_repository_update(temp_db):
...
def test_search_session_repository_get_all(temp_db):
...
def test_job_session_foreign_key(temp_db):
...
def test_session_count(temp_db):
